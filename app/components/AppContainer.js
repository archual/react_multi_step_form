...
export class AppContainer extends React.Component {
  ...
  onUnload = (event) => {
    if (window.Drupal.settings.adventure) {
      if (!window.Drupal.settings.adventure.submit && !window.Drupal.settings.adventure.download) {
        event.returnValue = Drupal.t("Looks like you're closing this window without saving. You will lose all unsaved work.");
        return Drupal.t("Looks like you're closing this window without saving. You will lose all unsaved work.");
      }
